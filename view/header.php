...
<head>
    ...
    <title>Nhóm 7 - Website bán trà sữa</title>
    ...
    <header>
        <div class="relative">
                <div class="hd container">
                    <div class="h-left ">
                        <a href=""><img src="view/images/Logotoco.png" alt="" width="100px"></a>
                        <ul>
                            ...
                            ?>
                                ...
                                <li>
                                    ...
                                    <div style="display: flex;position: absolute;align-items: center;top:27px;margin-left: 50px;">
                                        <div><img style="border-radius: 40px;" width="50px;" src="view/images/Logotoco.png" alt=""></div>
