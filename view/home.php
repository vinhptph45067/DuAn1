...
<div class="fl-3">
  <div class="lsp">
    <img src="view/images/trasua1.jpg" alt="">
    <img src="view/images/trasua2.jpg" alt="">
    <img src="view/images/trasua3.jpg" alt="">
  </div>
</div>
...
<main>
  ...
  <div class="title1 container">
    <b>TOP 4 TRÀ SỮA BÁN CHẠY</b>
    <p>Trà sữa nhập khẩu, uy tín chất lượng</p>
  </div>
...
';
  ...
  <div class="title1 container">
    <b>SẢN PHẨM MỚI</b>
    <p>Trà sữa ngon ,được nhiều người ưa chuộng và tin cậy </p>
  </div>
  ...
  <script>
    var imgArray = [
      './view/images/bannerts1.png',
      './view/images/bannerts2.png',
      './view/images/bannerts3.png',
    ];
    var curIndex = 0;
